<h2><a href="https://leetcode.com/problems/range-sum-query-2d-mutable">Range Sum Query 2D - Mutable</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>Given a 2D matrix <code>matrix</code>, handle multiple queries of the following types:</p>
